...
lifecycle actions, device vendors, device installation lookup, attached device
cameras, vehicle counts, vehicle types, scheduled-report templates, scheduled
report restore, read-only metadata and settings reference data, fuel types, and
the dashboard-observed vehicle restore method.
