...
__export(index_exports, {
  ...
  DigitalFormsService: () => DigitalFormsService,
  DriversService: () => DriversService,
  FuelService: () => FuelService,
  GeofencesService: () => GeofencesService,
  HttpClient: () => HttpClient,
  LinxioApiError: () => LinxioApiError,
  LinxioAuthenticationError: () => LinxioAuthenticationError,
  LinxioClient: () => LinxioClient,
  LinxioConfigurationError: () => LinxioConfigurationError,
  LinxioError: () => LinxioError,
  LinxioNetworkError: () => LinxioNetworkError,
  LinxioRealtimeError: () => LinxioRealtimeError,
  LinxioTimeoutError: () => LinxioTimeoutError,
  LinxioValidationError: () => LinxioValidationError,
  MetadataService: () => MetadataService,
  RealtimeClient: () => RealtimeClient,
  ReportsService: () => ReportsService,
  ResellersService: () => ResellersService,
  RoutesService: () => RoutesService,
  SensorsService: () => SensorsService,
  UsersService: () => UsersService,
  VehiclesService: () => VehiclesService,
  collectPages: () => collectPages,
  compareDashboardEndpointCoverage: () => compareDashboardEndpointCoverage,
  createClient: () => createClient,
  extractDashboardEndpoints: () => extractDashboardEndpoints,
  fail: () => fail,
  flattenEndpointDefinitions: () => flattenEndpointDefinitions,
  isLinxioFailure: () => isLinxioFailure,
  linxioEndpoints: () => linxioEndpoints,
  ok: () => ok,
  pageFail: () => pageFail,
  pageOk: () => pageOk,
  streamPages: () => streamPages,
  toLinxioError: () => toLinxioError,
  toResult: () => toResult,
  unwrapLinxioPageResult: () => unwrapLinxioPageResult,
  unwrapLinxioResult: () => unwrapLinxioResult
});
...
var RealtimeClient = class {
  ...
  connect(namespace, token = this.getToken()) {
    ...
    const socket = (0, import_socket.io)(`${this.baseUrl}/${namespace}`, {
      path: this.path,
      query: { token },
      reconnection: true,
